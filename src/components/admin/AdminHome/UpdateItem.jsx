...
const UpdateItem = ({ isUpdateModal, setIsUpdateModal, itemData, fetchItems }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        fetchItems();
        setTimeout(() => setIsUpdateModal(false), 1000);
      }
    } catch (error) {
...
// const UpdateItem = ({isUpdateModal, setIsUpdateModal, itemData}) => {
...
//                       <h2 className="text-xl font-semibold">Update Item</h2>
//                       <button className="text-gray-500 hover:text-gray-700" onClick={() => {setIsUpdateModal(false)}}>
...
//                           </div>
//                           <div className="mb-4">
//                               <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="availibility">
//                                  Category
//                               </label>
//                               <select 
//                                   className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
...
//                               >
//                                   <option value={itemData.availibility}>{itemData.availibility}</option>
//                                   <option value="available">Available</option>
//                                   <option value="notAvailable">Not Available</option>
//                               </select>
//                           </div>
